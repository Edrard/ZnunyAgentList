...
```text
/path/to/output/ZnunyAgentList-1.6.6.opm
```
...
```bash
cd "$ZNUNY_HOME"
su -s /bin/bash -c "bin/otrs.Console.pl Admin::Package::Install /path/to/output/ZnunyAgentList-1.6.6.opm" otrs
```
...
```bash
cd "$ZNUNY_HOME"
su -s /bin/bash -c "bin/otrs.Console.pl Admin::Package::Upgrade /path/to/output/ZnunyAgentList-1.6.6.opm" otrs
```
